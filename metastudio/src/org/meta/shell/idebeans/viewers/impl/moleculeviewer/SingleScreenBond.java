...
/**
 * Represents a single bond on the screen.
 *
 * @author  V.Ganesh
 * @version 2.0 (Part of MeTA v2.0)
 */
public class SingleScreenBond extends ScreenBond {        
    
    /** Creates a new instance of SingleScreenBond */
    public SingleScreenBond(ScreenAtom atom1, ScreenAtom atom2) {
        super(atom1, atom2);
    }

    /**
     * Draw the screen bond.
     *
     * @param g2d instance of Graphics2D object
     */
    @Override
