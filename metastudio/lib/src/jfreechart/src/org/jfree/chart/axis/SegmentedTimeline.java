...
public class SegmentedTimeline implements Timeline, Cloneable, Serializable {
     ...
     */
    private List<Segment> exceptionSegments = new ArrayList<Segment>();
     ...
     */
    public List<Segment> getExceptionSegments() {
     ...
     */
    public void setExceptionSegments(List<Segment> exceptionSegments) {
...
//                }
     ...
     */
    public class Segment implements Comparable<Segment>, Cloneable, Serializable {
