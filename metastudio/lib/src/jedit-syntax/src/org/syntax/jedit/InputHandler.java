 ...
 *
 * @author Slava Pestov
 * @modified V.Ganesh, support for undo / redo key bindings added, tabs
 *           expanded as 4 spaces
...
public abstract class InputHandler extends KeyAdapter {
    ...
    // Undo / Redo
    public static final ActionListener ACTION_UNDO = new action_undo();
    public static final ActionListener ACTION_REDO = new action_redo();
    ...
    static {
        ...
        actions.put("action-undo", ACTION_UNDO);
        actions.put("action-redo", ACTION_REDO);
    }
    ...
    public static class action_undo implements ActionListener,
    InputHandler.NonRepeatable {
        public void actionPerformed(ActionEvent evt) {
            JEditTextArea textArea = getTextArea(evt);
            textArea.undo();
    ...
    public static class action_redo implements ActionListener,
    InputHandler.NonRepeatable {
        public void actionPerformed(ActionEvent evt) {
            JEditTextArea textArea = getTextArea(evt);
            textArea.redo();
