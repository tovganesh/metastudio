...
public class KeywordPerspective extends MotionKeywordParser {
    
    public KeywordPerspective() {
    ...
    public void parse(Tokenizer st) throws Exception {
        // Expect fov
        match(st, TK_NUMBER);
        float fov = (float) st.nval;
        parser.perspective(fov);
    }
