...
public class KeywordTransform extends MotionKeywordParser {
    
    public KeywordTransform() {
        validStates.add(Parser.State.OBJECT);
    }

    public void parse(Tokenizer st) throws Exception {
        Matrix4f transform = readMatrix(st);
        parser.setTransform(transform);
    }
