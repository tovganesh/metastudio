...
public class KeywordConcatTransform extends MotionKeywordParser {
    
    public KeywordConcatTransform() {
        validStates.add(Parser.State.OBJECT);
    }

    public void parse(Tokenizer st) throws Exception {
        Matrix4f trans = readMatrix(st);
        parser.concatTransform(trans);
    }
