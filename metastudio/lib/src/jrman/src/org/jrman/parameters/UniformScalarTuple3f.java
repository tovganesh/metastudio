...
public class UniformScalarTuple3f extends Parameter {
    ...
    public UniformScalarTuple3f(Declaration declaration, float x, float y, float z) {
        super(declaration);
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public void getValue(Tuple3f out) {
        out.x = x;
        out.y = y;
        out.z = z;
    }
