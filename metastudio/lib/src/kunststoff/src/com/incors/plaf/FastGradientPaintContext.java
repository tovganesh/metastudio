...
//			raster = null;
	...
	private static WeakHashMap<GradientInfo,  java.lang.ref.WeakReference> gradientCache 
                         = new WeakHashMap<GradientInfo,  java.lang.ref.WeakReference>();
	...
	FastGradientPaintContext(ColorModel cm, Rectangle r, int sc, int ec, boolean ver ) {
		...
		if ( o != null ) {
			...
			gradientCache.put( info, 
                                new java.lang.ref.WeakReference<Gradient>( gradient = new Gradient( info ) ) );
