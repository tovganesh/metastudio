 ...
 *                                                                           *
 * @modified V. Ganesh (for thread management)                               *
 *****************************************************************************/
	...
	MouseListener, ActionListener, PropertyChangeListener 
{
    ...
    /** Following added by Ganesh */
    private Thread jConsoleThread = null;
	...
	public JConsole( InputStream cin, OutputStream cout )  
	{
		...
		if ( inPipe == null ) {
			...
			try {
                ...
                /** Following modified by Ganesh */
		// Start the inpipe watcher
		jConsoleThread = new Thread(this);
                jConsoleThread.setName("JConsole Thread");
                jConsoleThread.start();
