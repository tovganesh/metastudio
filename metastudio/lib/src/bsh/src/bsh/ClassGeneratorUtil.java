...
public class ClassGeneratorUtil implements Opcodes
{
	...
	*/
	public byte [] generateClass() 
	{
		...
		cw.visit(V1_6, classMods, fqClassName, null, superClassName,
			     interfaceNames);
	...
	*/
	...
	{
		cw.visitField(modifiers, fieldName, type, type, null/*value*/).visitEnd();
	}
	...
	*/
		...
		String returnType, String[] paramTypes, int modifiers, ClassWriter cw ) 
	{
		...
		MethodVisitor cv = cw.visitMethod(
			modifiers, methodName, methodDescriptor, methodDescriptor, exceptions );
	...
	*/
		...
		int index, String [] paramTypes, int modifiers, ClassWriter cw ) 
	{
		...
		MethodVisitor cv =
			cw.visitMethod( modifiers, "<init>", methodDescriptor, methodDescriptor, exceptions );
	...
	*/
											 ...
											 String returnType, String[] paramTypes, int modifiers, ClassWriter cw )
	{
		...
		// Add method body
		MethodVisitor cv = cw.visitMethod(
			modifiers, "_bshSuper"+methodName, methodDescriptor, methodDescriptor, exceptions );
