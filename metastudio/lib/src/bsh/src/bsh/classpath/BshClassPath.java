...
public class BshClassPath
    ...
    ArrayList<WeakReference<ClassPathListener>> listeners
            = new ArrayList<WeakReference<ClassPathListener>>();
    ...
    public void addListener(ClassPathListener l) {
        listeners.add(new WeakReference<ClassPathListener>(l));
    }
    ...
    void notifyListeners() {
        for(WeakReference<ClassPathListener> wr : listeners) {
            ClassPathListener l = wr.get();

            if (l == null) listeners.remove(wr);
